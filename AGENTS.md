...
Issue #1 holds case requirements. Current Refiner scope is recorded in `docs/DESIGN-v2-refiner-1080p.md`, `docs/DESIGN-v2.1-mov.md`, `docs/DESIGN-v2.2-duration-fps.md` and `docs/DESIGN-v2.3-normalization.md`; current deployment/evidence is in `docs/PROGRESS.md`. These documents distinguish technical validation from the still-unmet closed-mouth clone behavior.
